...
<hr>
<br>
<div class="form-group" align="center"><h2><u>Rent Books Portal</u></h2></div>
<form action="BookStoreServlet" method="post">
  ...
  <div class="form-group">
    <label for="isbn">Enter the name of the book</label>
    <input type="text" class="form-control" name="name" placeholder="Book-Name">
  </div>
  <button type="submit" name="chk_cust_rent_btn" class="btn btn-primary">Search Customer</button>
</form>
</body>
</html>