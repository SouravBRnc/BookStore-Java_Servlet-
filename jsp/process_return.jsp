...
<hr>
<br>
<div class="form-group" align="center"><h2><u>Process Returns Portal</u></h2></div>
<form action="BookStoreServlet" method="post">
	<div class="form-group">
    <label for="email">Enter the customer's ID</label>
    <input type="text" class="form-control" name="cid" placeholder="customer id">
  </div>
  <div class="form-group">
    <label for="isbn">Enter the ISBN of the book</label>
    <input type="text" class="form-control" name="isbn" placeholder="isbn">
  </div>
  <button type="submit" name="process_return_btn" class="btn btn-primary">Search Customer</button>
</form>
</body>
</html>